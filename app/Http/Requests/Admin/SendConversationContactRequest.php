...
class SendConversationReplyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'audio_url' => ['nullable', 'url', 'max:2048', 'required_without:audio_file'],
            'audio_file' => ['nullable', 'file', 'max:16384', 'mimetypes:audio/ogg,audio/opus,application/ogg,audio/mpeg,audio/mp3,audio/mp4,audio/x-m4a,audio/aac'],
